  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: leftstickangle
  {
    cdr << ros_message->leftstickangle;
  }

  // Field name: rightstickangle
  {
    cdr << ros_message->rightstickangle;
  }

  // Field name: dpadangle
  {
    cdr << ros_message->dpadangle;
  }

  // Field name: lefttrigger
  {
    cdr << ros_message->lefttrigger;
  }

  // Field name: righttrigger
  {
    cdr << ros_message->righttrigger;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name leftstickangle
  {
    size_t item_size = sizeof(ros_message->leftstickangle);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name rightstickangle
  {
    size_t item_size = sizeof(ros_message->rightstickangle);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name dpadangle
  {
    size_t item_size = sizeof(ros_message->dpadangle);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name lefttrigger
  {
    size_t item_size = sizeof(ros_message->lefttrigger);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name righttrigger
  {
    size_t item_size = sizeof(ros_message->righttrigger);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name a
